...
int fileCounter = 0;
int fileLimit = 1000;
char *file_prefix = "../brickhouseNEW";
...
int create_world_border_with_door(double vm[4][4], double vi[4][4], double offsetm[4][4],
  ...
  objtransperency[num_objects] = 0;
  objtexreflect[num_objects] = 0;
  objtesselation[num_objects][0] = 4;
  objtesselation[num_objects][1] = 4;
  objtessoffset[num_objects][0] = 0;
  objtessoffset[num_objects][1] = 0;
  objshadow[num_objects] = -1;
  objtexture[num_objects] = "seamlessspacegood.xwd";
	
  Tn = 0 ;
  Ttypelist[Tn] = SX ; Tvlist[Tn] =  800    ; Tn++ ;
  Ttypelist[Tn] = SY ; Tvlist[Tn] =  800    ; Tn++ ;
  ...
  //sun sphere
  obtype[num_objects] = 0; 
  color[num_objects][0] = 0.94 ;
  color[num_objects][1] = 0.91 ; 
  color[num_objects][2] = 0.76 ;
  objreflectivity[num_objects] = -1;
  objtransperency[num_objects] = 0;
  objtexreflect[num_objects] = 0;
  objtesselation[num_objects][0] = 1;
  ...
  Ttypelist[Tn] = SZ ; Tvlist[Tn] =  2    ; Tn++ ;
  Ttypelist[Tn] = TX ; Tvlist[Tn] =  30    ; Tn++ ;
  ...
  objtransperency[num_objects] = 0;
  objtexreflect[num_objects] = 0;
  objtesselation[num_objects][0] = 8;
  objtesselation[num_objects][1] = 8;
  objtessoffset[num_objects][0] = 0;
  objtessoffset[num_objects][1] = 0;
  objshadow[num_objects] = 0;
  objtexture[num_objects] = "grassGood.xwd";

	
  Tn = 0 ;
  Ttypelist[Tn] = SX ; Tvlist[Tn] =  300    ; Tn++ ;
  Ttypelist[Tn] = SY ; Tvlist[Tn] =  300    ; Tn++ ;
  Ttypelist[Tn] = SZ ; Tvlist[Tn] =  1    ; Tn++ ;
  Ttypelist[Tn] = RX ; Tvlist[Tn] =  90    ; Tn++ ;
...
int set_lights(){
  ...
  light_in_world_space[num_lights][0] = 30;
  light_in_world_space[num_lights][1] = 50;
  light_in_world_space[num_lights][2] = -100;
  light_color[num_lights][0] = 0.94;
  light_color[num_lights][1] = 0.91;
  light_color[num_lights][2] = 0.76;
  light_power[num_lights] = 800;
  light_radius[num_lights] = 600;
  num_lights++;
